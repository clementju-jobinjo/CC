...
public class ValueVisitor extends DepthFirstVoidVisitor {
	...
	public ValueVisitor(List<Scope> scopes, Map<String, Scope> classOrMethodOrVariableToScope,Map<String, Scope> methodToScope ) {
		this.scopes = scopes;
...
//
//		if (valueOfLastVisitedExpression.getTypeName() != returnType.getTypeName()) {
...
//		if (valueOfLastVisitedExpression != Boolean.BooleanSingleton) {
...
//		Type leftType = typeOfLastVisitedIdentifier;
		Variable var = currentScope.getVariable(e.identifier.nodeToken.tokenImage);
		
		e.expression.accept(this);
		String value = valueOfLastVisitedExpression;
...
//		Type intraBracketType = valueOfLastVisitedExpression;
//		
//		
...
//		e.expression.accept(this);
//		
//		Type rightType = valueOfLastVisitedExpression;
//		
...
//	}
	...
	@Override
	public void visit(IntArrayConstructionCall intArrayConstCall) {
		intArrayConstCall.expression.accept(this);
		String arrayLength = valueOfLastVisitedExpression;
	}
...
//		}
//		
		valueOfLastVisitedExpression = "";
		
	}
	
	
	public String getValueOfLastExpression() {
		return valueOfLastVisitedExpression;
	}
